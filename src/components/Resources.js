    ...
    return (
        <div className="resources-container">
            <section className="help-article">
                ...
                <a href="https://www.sacl.com.au/"><img src={hotlinelogo} alt="" className="imageone" /></a>
            </section>
            <section className="help-article">
                <h3>Unsure if you've been assaulted?</h3>
                <a href="https://au.reachout.com/articles/sexual-assault#2"><img src={reachlogo} alt="" className="imagetwo"/></a>
            </section>
        </div>
